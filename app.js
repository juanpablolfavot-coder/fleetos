...
// ── DATOS DE LA FLOTA ──
App.data.vehicles = [
  { id:1,  code:'INT-01', plate:'ABC 101', brand:'Mercedes-Benz', model:'Actros 2651', year:2019, type:'tractor',   status:'ok',     km:284500, base:'Central', driver:'Juan Pérez',    cost_km:0.187 },
  { id:2,  code:'INT-02', plate:'ABC 102', brand:'Scania',        model:'R 450',       year:2020, type:'tractor',   status:'ok',     km:198300, base:'Central', driver:'Carlos López',  cost_km:0.172 },
  { id:3,  code:'INT-03', plate:'ABC 103', brand:'Volvo',         model:'FH 500',      year:2018, type:'tractor',   status:'ok',     km:341200, base:'Norte',   driver:'Miguel Torres', cost_km:0.215 },
  { id:4,  code:'INT-04', plate:'ABC 104', brand:'DAF',           model:'XF 480',      year:2021, type:'tractor',   status:'ok',     km:122800, base:'Central', driver:'Sergio Ruiz',   cost_km:0.163 },
  { id:5,  code:'INT-05', plate:'ABC 105', brand:'Mercedes-Benz', model:'Actros 2545', year:2017, type:'tractor',   status:'warn',   km:412600, base:'Sur',     driver:'Pablo Díaz',    cost_km:0.231 },
  { id:6,  code:'INT-06', plate:'DEF 201', brand:'Iveco',         model:'Trakker 440', year:2019, type:'camion',    status:'ok',     km:189400, base:'Central', driver:'Luis García',   cost_km:0.198 },
  { id:7,  code:'INT-07', plate:'DEF 202', brand:'Mercedes-Benz', model:'Atego 1730',  year:2020, type:'camion',    status:'ok',     km:98200,  base:'Central', driver:'Ramón Vega',    cost_km:0.184 },
  { id:8,  code:'INT-08', plate:'DEF 203', brand:'Volvo',         model:'FMX 420',     year:2016, type:'camion',    status:'ok',     km:521000, base:'Norte',   driver:'Hugo Sosa',     cost_km:0.312 },
  { id:9,  code:'INT-09', plate:'DEF 204', brand:'Scania',        model:'G 410',       year:2022, type:'camion',    status:'ok',     km:45800,  base:'Central', driver:'Néstor Cruz',   cost_km:0.158 },
  { id:10, code:'INT-10', plate:'DEF 205', brand:'Iveco',         model:'Stralis 460', year:2018, type:'camion',    status:'ok',     km:267300, base:'Sur',     driver:'Omar Blanco',   cost_km:0.203 },
  { id:11, code:'INT-11', plate:'GHI 301', brand:'Mercedes-Benz', model:'Actros 2651', year:2020, type:'tractor',   status:'ok',     km:176400, base:'Central', driver:'Fabio Moreno',  cost_km:0.179 },
  { id:12, code:'INT-12', plate:'GHI 302', brand:'Scania',        model:'R 500',       year:2019, type:'tractor',   status:'taller', km:298100, base:'Central', driver:'Darío Luna',    cost_km:0.195 },
  { id:13, code:'INT-13', plate:'GHI 303', brand:'Volvo',         model:'FH 460',      year:2021, type:'tractor',   status:'ok',     km:134700, base:'Norte',   driver:'Claudio Ríos',  cost_km:0.168 },
  { id:14, code:'INT-14', plate:'JKL 401', brand:'Volkswagen',    model:'Constellation 24.280', year:2018, type:'camion', status:'ok', km:312400, base:'Sur', driver:'Andrés Silva', cost_km:0.221 },
  { id:15, code:'INT-15', plate:'JKL 402', brand:'Ford',          model:'Cargo 2842',  year:2017, type:'camion',    status:'ok',     km:445200, base:'Central', driver:'Marcos Ibáñez', cost_km:0.247 },
  { id:16, code:'INT-16', plate:'JKL 403', brand:'Mercedes-Benz', model:'Atego 2426',  year:2022, type:'camion',    status:'ok',     km:38900,  base:'Norte',   driver:'Ricardo Ponce', cost_km:0.155 },
  { id:17, code:'INT-17', plate:'MNO 501', brand:'Scania',        model:'R 450',       year:2018, type:'tractor',   status:'warn',   km:389500, base:'Sur',     driver:'Gustavo Leal',  cost_km:0.228 },
  { id:18, code:'INT-18', plate:'MNO 502', brand:'Volvo',         model:'FM 370',      year:2020, type:'camion',    status:'ok',     km:187600, base:'Central', driver:'Eduardo Moya',  cost_km:0.191 },
  { id:19, code:'INT-19', plate:'PQR 601', brand:'Mercedes-Benz', model:'Actros 2553', year:2021, type:'tractor',   status:'ok',     km:98400,  base:'Central', driver:'Vicente Oros',  cost_km:0.171 },
  { id:20, code:'INT-20', plate:'PQR 602', brand:'Scania',        model:'G 380',       year:2016, type:'camion',    status:'ok',     km:498700, base:'Norte',   driver:'Bernardo Paz',  cost_km:0.268 },
  { id:21, code:'INT-21', plate:'STU 701', brand:'Volvo',         model:'FH 540',      year:2023, type:'tractor',   status:'ok',     km:22300,  base:'Central', driver:'Fernando Ruiz', cost_km:0.148 },
  { id:22, code:'INT-22', plate:'STU 702', brand:'DAF',           model:'CF 450',      year:2019, type:'tractor',   status:'ok',     km:256800, base:'Sur',     driver:'Javier Mora',   cost_km:0.274 },
  { id:23, code:'INT-23', plate:'STU 703', brand:'Iveco',         model:'Eurocargo 170',year:2020,type:'camion',    status:'ok',     km:143200, base:'Central', driver:'Diego Flores',  cost_km:0.189 },
  { id:24, code:'INT-24', plate:'VWX 801', brand:'Mercedes-Benz', model:'Actros 2651', year:2018, type:'tractor',   status:'ok',     km:334600, base:'Norte',   driver:'Martín Reyes',  cost_km:0.208 },
  { id:25, code:'INT-25', plate:'VWX 802', brand:'Scania',        model:'R 580',       year:2022, type:'tractor',   status:'ok',     km:67400,  base:'Central', driver:'Gonzalo Vera',  cost_km:0.162 },
  { id:26, code:'INT-26', plate:'YZA 901', brand:'Volvo',         model:'FMX 500',     year:2019, type:'camion',    status:'ok',     km:221300, base:'Sur',     driver:'Horacio Abad',  cost_km:0.197 },
  { id:27, code:'INT-27', plate:'YZA 902', brand:'Ford',          model:'Cargo 1723',  year:2021, type:'camion',    status:'ok',     km:89600,  base:'Central', driver:'Leandro Vidal', cost_km:0.176 },
  { id:28, code:'INT-28', plate:'BCD 011', brand:'Mercedes-Benz', model:'Arocs 3351',  year:2020, type:'camion',    status:'taller', km:178900, base:'Central', driver:'Rodrigo Solís', cost_km:0.194 },
  { id:29, code:'INT-29', plate:'BCD 012', brand:'Scania',        model:'P 320',       year:2017, type:'camion',    status:'ok',     km:401200, base:'Norte',   driver:'Óscar Bravo',   cost_km:0.241 },
  { id:30, code:'INT-30', plate:'EFG 021', brand:'Volvo',         model:'FH 420',      year:2021, type:'tractor',   status:'ok',     km:112300, base:'Central', driver:'Walter Lara',   cost_km:0.173 },
  { id:31, code:'INT-31', plate:'EFG 022', brand:'DAF',           model:'XF 530',      year:2020, type:'tractor',   status:'detenida',km:234100,base:'Central', driver:'Cristian Nava', cost_km:0.196 },
  { id:32, code:'INT-32', plate:'EFG 023', brand:'Iveco',         model:'S-Way 570',   year:2022, type:'tractor',   status:'ok',     km:56700,  base:'Sur',     driver:'Ismael Rosa',   cost_km:0.159 },
  { id:33, code:'INT-33', plate:'HIJ 031', brand:'Mercedes-Benz', model:'Actros 2545', year:2019, type:'tractor',   status:'ok',     km:287400, base:'Central', driver:'Arnaldo Peña',  cost_km:0.201 },
  { id:34, code:'INT-34', plate:'HIJ 032', brand:'Scania',        model:'R 450',       year:2020, type:'tractor',   status:'ok',     km:199600, base:'Norte',   driver:'Nelson Ojeda',  cost_km:0.183 },
  { id:35, code:'INT-35', plate:'HIJ 033', brand:'Volvo',         model:'FH 500',      year:2018, type:'tractor',   status:'warn',   km:378200, base:'Sur',     driver:'Álvaro Cano',   cost_km:0.219 },
  { id:36, code:'INT-36', plate:'KLM 041', brand:'Ford',          model:'Cargo 2842',  year:2021, type:'camion',    status:'ok',     km:98300,  base:'Central', driver:'Ernesto Vale',  cost_km:0.177 },
  { id:37, code:'INT-37', plate:'KLM 042', brand:'Volkswagen',    model:'Meteor 29.520',year:2022,type:'camion',    status:'ok',     km:42100,  base:'Central', driver:'Héctor Sáenz',  cost_km:0.153 },
  { id:38, code:'INT-38', plate:'NOP 051', brand:'Mercedes-Benz', model:'Atego 1730',  year:2019, type:'camion',    status:'ok',     km:234800, base:'Norte',   driver:'Patricio Melo', cost_km:0.195 },
  { id:39, code:'INT-39', plate:'NOP 052', brand:'Scania',        model:'G 410',       year:2020, type:'camion',    status:'ok',     km:167300, base:'Central', driver:'Alejandro Cid', cost_km:0.181 },
  { id:40, code:'INT-40', plate:'NOP 053', brand:'Volvo',         model:'FM 410',      year:2021, type:'camion',    status:'ok',     km:134500, base:'Sur',     driver:'Germán Ríos',   cost_km:0.174 },
  { id:41, code:'INT-41', plate:'QRS 061', brand:'DAF',           model:'CF 480',      year:2018, type:'tractor',   status:'ok',     km:356900, base:'Central', driver:'Rubén Garza',   cost_km:0.222 },
  { id:42, code:'INT-42', plate:'QRS 062', brand:'Iveco',         model:'Trakker 480', year:2019, type:'tractor',   status:'ok',     km:298700, base:'Norte',   driver:'Ramiro Fuentes',cost_km:0.207 },
  { id:43, code:'INT-43', plate:'TUV 071', brand:'Mercedes-Benz', model:'Actros 2651', year:2023, type:'tractor',   status:'ok',     km:18900,  base:'Central', driver:'Damián Lozano', cost_km:0.145 },
  { id:44, code:'INT-44', plate:'TUV 072', brand:'Scania',        model:'R 500',       year:2022, type:'tractor',   status:'ok',     km:78400,  base:'Sur',     driver:'Mauricio Ríos', cost_km:0.165 },
  { id:45, code:'INT-45', plate:'WXY 081', brand:'Volvo',         model:'FH 460',      year:2021, type:'tractor',   status:'ok',     km:145600, base:'Central', driver:'Sebastián Gil', cost_km:0.178 },
];

App.data.workOrders = [
  { id:'OT-0284', vehicle:'INT-31', plate:'EFG 022', type:'Correctivo', status:'Cerrada', priority:'Urgente',
    desc:'Falla sistema eléctrico — unidad detenida', mechanic:'Carlos R.',
    opened:'2026-04-09 06:20', closed:'2026-04-09 23:38',
    causa_raiz:'Se detectó fusible principal quemado y relay de arranque defectuoso. Se reemplazaron ambos componentes.',
    parts:[
      { name:'Relay de arranque DAF XF',       origin:'stock',  stockId:9,  qty:1, cost:18500, unit:'un' },
      { name:'Fusible principal 80A',           origin:'stock',  stockId:15, qty:2, cost:4200,  unit:'un' },
      { name:'Cable de masa 35mm² x 1.5m',     origin:'compra', stockId:null, qty:1, cost:3800, unit:'un' },
    ],
    parts_cost:30700, labor_cost:24000 },

  { id:'OT-0283', vehicle:'INT-12', plate:'GHI 302', type:'Preventivo', status:'En proceso', priority:'Normal',
    desc:'Service 20.000 km — cambio aceite y filtros', mechanic:'Rubén M.',
    opened:'2026-04-09 08:00',
    parts:[
      { name:'Filtro aceite motor MB Actros',   origin:'stock', stockId:1, qty:1, cost:4200,  unit:'un' },
      { name:'Filtro combustible primario MB',  origin:'stock', stockId:3, qty:1, cost:2800,  unit:'un' },
      { name:'Filtro separador agua combustible',origin:'stock',stockId:14,qty:1, cost:3200,  unit:'un' },
      { name:'Aceite motor 15W-40 bulk',        origin:'stock', stockId:5, qty:38,cost:820,   unit:'L'  },
    ],
    parts_cost:42360, labor_cost:18000 },

  { id:'OT-0282', vehicle:'INT-28', plate:'BCD 011', type:'Correctivo', status:'Esperando repuesto', priority:'Media',
    desc:'Reparación suspensión delantera — espera bulón especial', mechanic:'Jorge P.',
    opened:'2026-04-08 15:30',
    parts:[
      { name:'Buje dirección delantero',        origin:'stock',  stockId:10, qty:2, cost:22000, unit:'un' },
      { name:'Bulón especial M24 suspensión',   origin:'compra', stockId:null, qty:4, cost:5750, unit:'un' },
    ],
    parts_cost:67000, labor_cost:21000 },

  { id:'OT-0281', vehicle:'INT-35', plate:'HIJ 033', type:'Preventivo', status:'Pendiente', priority:'Normal',
    desc:'Revisión frenos y cubiertas', mechanic:'—',
    opened:'2026-04-09 09:00', parts:[], parts_cost:0, labor_cost:0 },

  { id:'OT-0280', vehicle:'INT-07', plate:'DEF 202', type:'Preventivo', status:'Pendiente', priority:'Normal',
    desc:'Cambio filtro separador agua y filtro combustible', mechanic:'—',
    opened:'2026-04-09 09:15', parts:[], parts_cost:0, labor_cost:0 },

  { id:'OT-0279', vehicle:'INT-05', plate:'ABC 105', type:'Preventivo', status:'Cerrada', priority:'Normal',
    desc:'Engrase general — 30.000 km', mechanic:'Rubén M.',
    opened:'2026-04-08 08:00', closed:'2026-04-08 16:30',
    causa_raiz:'Engrase completo de 28 puntos. Sin novedades.',
    parts:[
      { name:'Grasa EP2 multiuso 20kg balde', origin:'stock', stockId:8, qty:2, cost:4200, unit:'kg' },
    ],
    parts_cost:8400, labor_cost:15000 },

  { id:'OT-0278', vehicle:'INT-22', plate:'STU 702', type:'Correctivo', status:'Cerrada', priority:'Media',
    desc:'Cambio rulemanes masa delantera', mechanic:'Carlos R.',
    opened:'2026-04-07 10:00', closed:'2026-04-07 18:00',
    causa_raiz:'Rulemán izquierdo con juego excesivo y ruido. Se reemplazó par completo.',
    parts:[
      { name:'Rulemán masa delantera MB',      origin:'stock', stockId:10, qty:2, cost:22000, unit:'un' },
      { name:'Retén masa delantera',           origin:'compra',stockId:null, qty:2, cost:4800, unit:'un' },
      { name:'Aceite motor 15W-40 bulk',       origin:'stock', stockId:5,  qty:2, cost:820,   unit:'L'  },
    ],
    parts_cost:54440, labor_cost:28000 },

  { id:'OT-0277', vehicle:'INT-17', plate:'MNO 501', type:'Correctivo', status:'Cerrada', priority:'Media',
    desc:'Reparación sistema neumático — válvula de freno', mechanic:'Jorge P.',
    opened:'2026-04-07 13:00', closed:'2026-04-07 20:00',
    causa_raiz:'Válvula relay de freno trasero con pérdida de presión. Reemplazada por unidad nueva.',
    parts:[
      { name:'Válvula relay freno trasero',    origin:'compra', stockId:null, qty:1, cost:38000, unit:'un' },
      { name:'Manguera neumática 8mm x 1.5m', origin:'compra', stockId:null, qty:2, cost:3500,  unit:'un' },
    ],
    parts_cost:45000, labor_cost:20000 },

  { id:'OT-0276', vehicle:'INT-08', plate:'DEF 203', type:'Preventivo', status:'Cerrada', priority:'Normal',
    desc:'Service mayor 100.000 km — aceite motor, caja, diferencial', mechanic:'Rubén M.',
    opened:'2026-04-06 08:00', closed:'2026-04-06 20:00',
    causa_raiz:'Service mayor completo. Sin novedades adicionales.',
    parts:[
      { name:'Aceite motor 15W-40 bulk',        origin:'stock', stockId:5,  qty:38, cost:820,  unit:'L'  },
      { name:'Aceite caja Meritor manual',       origin:'stock', stockId:6,  qty:9,  cost:1450, unit:'L'  },
      { name:'Aceite diferencial 85W-140',       origin:'stock', stockId:7,  qty:14, cost:1320, unit:'L'  },
      { name:'Filtro aceite motor MB Actros',    origin:'stock', stockId:1,  qty:1,  cost:4200, unit:'un' },
      { name:'Filtro combustible primario MB',   origin:'stock', stockId:3,  qty:1,  cost:2800, unit:'un' },
      { name:'Filtro separador agua combustible',origin:'stock', stockId:14, qty:1,  cost:3200, unit:'un' },
      { name:'Filtro aire MB Actros',            origin:'stock', stockId:4,  qty:1,  cost:6500, unit:'un' },
    ],
    parts_cost:141780, labor_cost:45000 },

  { id:'OT-0275', vehicle:'INT-03', plate:'ABC 103', type:'Correctivo', status:'Cerrada', priority:'Media',
    desc:'Cambio termostato motor — sobrecalentamiento', mechanic:'Carlos R.',
    opened:'2026-04-05 11:00', closed:'2026-04-05 16:00',
    causa_raiz:'Termostato trabado en cerrado. Motor llegó a 105°C. Reemplazado termostato y purgado sistema.',
    parts:[
      { name:'Termostato motor MB Actros',      origin:'compra', stockId:null, qty:1, cost:18500, unit:'un' },
      { name:'Líquido refrigerante orgánico 20L',origin:'stock', stockId:13,  qty:20, cost:380,  unit:'L'  },
    ],
    parts_cost:26100, labor_cost:16000 },
];


App.data.fuelLogs = [
  { id:1, vehicle:'INT-23', plate:'STU 703', driver:'Diego Flores',   liters:380, km:143200, ppu:1250, total:475000, date:'2026-04-09 07:14', place:'Cisterna central', status:'OK' },
  { id:2, vehicle:'INT-01', plate:'ABC 101', driver:'Juan Pérez',     liters:420, km:284500, ppu:1250, total:525000, date:'2026-04-09 07:45', place:'Cisterna central', status:'OK' },
  { id:3, vehicle:'INT-15', plate:'JKL 402', driver:'Marcos Ibáñez',  liters:510, km:445200, ppu:1280, total:652800, date:'2026-04-09 08:12', place:'YPF Ruta 9',       status:'ALERTA' },
  { id:4, vehicle:'INT-33', plate:'HIJ 031', driver:'Arnaldo Peña',   liters:355, km:287400, ppu:1250, total:443750, date:'2026-04-08 18:30', place:'Cisterna central', status:'OK' },
  { id:5, vehicle:'INT-41', plate:'QRS 061', driver:'Rubén Garza',    liters:490, km:356900, ppu:1250, total:612500, date:'2026-04-08 17:55', place:'Cisterna norte',   status:'OK' },
  { id:6, vehicle:'INT-20', plate:'PQR 602', driver:'Bernardo Paz',   liters:465, km:498700, ppu:1300, total:604500, date:'2026-04-08 16:20', place:'Shell autopista',  status:'OK' },
  { id:7, vehicle:'INT-29', plate:'BCD 012', driver:'Óscar Bravo',    liters:398, km:401200, ppu:1250, total:497500, date:'2026-04-08 15:40', place:'Cisterna central', status:'OK' },
  { id:8, vehicle:'INT-08', plate:'DEF 203', driver:'Hugo Sosa',      liters:548, km:521000, ppu:1250, total:685000, date:'2026-04-08 14:10', place:'Cisterna central', status:'OK' },
];

App.data.tires = [
  // ── INT-12 — Tractor 6×4 (10 cubiertas montadas)
  { serial:'BT-0441', pos:'1-DI',  vehicle:'INT-12', brand:'Bridgestone R168',  size:'295/80R22.5', km:68400,  depth:12, maxDepth:16, status:'ok',     purchase:180000 },
  { serial:'BT-0442', pos:'1-DD',  vehicle:'INT-12', brand:'Bridgestone R168',  size:'295/80R22.5', km:68400,  depth:11, maxDepth:16, status:'ok',     purchase:180000 },
  { serial:'MI-1102', pos:'2-TIE', vehicle:'INT-12', brand:'Michelin XDE2+',    size:'295/80R22.5', km:112300, depth:6,  maxDepth:14, status:'warn',   purchase:195000 },
  { serial:'MI-1103', pos:'2-TII', vehicle:'INT-12', brand:'Michelin XDE2+',    size:'295/80R22.5', km:112300, depth:4,  maxDepth:14, status:'danger', purchase:195000 },
  { serial:'MI-1104', pos:'2-TDE', vehicle:'INT-12', brand:'Michelin XDE2+',    size:'295/80R22.5', km:98200,  depth:7,  maxDepth:14, status:'warn',   purchase:195000 },
  { serial:'MI-1105', pos:'2-TDD', vehicle:'INT-12', brand:'Michelin XDE2+',    size:'295/80R22.5', km:98200,  depth:9,  maxDepth:14, status:'ok',     purchase:195000 },
  { serial:'CO-0881', pos:'3-TIE', vehicle:'INT-12', brand:'Continental HDL2',  size:'295/80R22.5', km:54100,  depth:11, maxDepth:14, status:'ok',     purchase:178000 },
  { serial:'CO-0882', pos:'3-TII', vehicle:'INT-12', brand:'Continental HDL2',  size:'295/80R22.5', km:54100,  depth:10, maxDepth:14, status:'ok',     purchase:178000 },
  { serial:'CO-0883', pos:'3-TDE', vehicle:'INT-12', brand:'Continental HDL2',  size:'295/80R22.5', km:54100,  depth:10, maxDepth:14, status:'ok',     purchase:178000 },
  { serial:'CO-0884', pos:'3-TDD', vehicle:'INT-12', brand:'Continental HDL2',  size:'295/80R22.5', km:54100,  depth:9,  maxDepth:14, status:'ok',     purchase:178000 },

  // ── INT-01 — Tractor 6×4 (10 cubiertas montadas)
  { serial:'GY-1011', pos:'1-DI',  vehicle:'INT-01', brand:'Goodyear KMAX S',   size:'295/80R22.5', km:44200,  depth:14, maxDepth:18, status:'ok',     purchase:185000 },
  { serial:'GY-1012', pos:'1-DD',  vehicle:'INT-01', brand:'Goodyear KMAX S',   size:'295/80R22.5', km:44200,  depth:13, maxDepth:18, status:'ok',     purchase:185000 },
  { serial:'GY-1013', pos:'2-TIE', vehicle:'INT-01', brand:'Goodyear KMAX D',   size:'295/80R22.5', km:44200,  depth:10, maxDepth:14, status:'ok',     purchase:190000 },
  { serial:'GY-1014', pos:'2-TII', vehicle:'INT-01', brand:'Goodyear KMAX D',   size:'295/80R22.5', km:44200,  depth:9,  maxDepth:14, status:'ok',     purchase:190000 },
  { serial:'GY-1015', pos:'2-TDE', vehicle:'INT-01', brand:'Goodyear KMAX D',   size:'295/80R22.5', km:44200,  depth:5,  maxDepth:14, status:'warn',   purchase:190000 },
  { serial:'GY-1016', pos:'2-TDD', vehicle:'INT-01', brand:'Goodyear KMAX D',   size:'295/80R22.5', km:44200,  depth:11, maxDepth:14, status:'ok',     purchase:190000 },
  { serial:'GY-1017', pos:'3-TIE', vehicle:'INT-01', brand:'Goodyear KMAX D',   size:'295/80R22.5', km:44200,  depth:10, maxDepth:14, status:'ok',     purchase:190000 },
  { serial:'GY-1018', pos:'3-TII', vehicle:'INT-01', brand:'Goodyear KMAX D',   size:'295/80R22.5', km:44200,  depth:9,  maxDepth:14, status:'ok',     purchase:190000 },
  { serial:'GY-1019', pos:'3-TDE', vehicle:'INT-01', brand:'Goodyear KMAX D',   size:'295/80R22.5', km:44200,  depth:10, maxDepth:14, status:'ok',     purchase:190000 },
  { serial:'GY-1020', pos:'3-TDD', vehicle:'INT-01', brand:'Goodyear KMAX D',   size:'295/80R22.5', km:44200,  depth:8,  maxDepth:14, status:'warn',   purchase:190000 },

  // ── INT-23 — Camión rígido 4×2 (6 cubiertas montadas)
  { serial:'PI-2301', pos:'1-DI',  vehicle:'INT-23', brand:'Pirelli TR85',       size:'315/70R22.5', km:31200,  depth:15, maxDepth:18, status:'ok',     purchase:175000 },
  { serial:'PI-2302', pos:'1-DD',  vehicle:'INT-23', brand:'Pirelli TR85',       size:'315/70R22.5', km:31200,  depth:14, maxDepth:18, status:'ok',     purchase:175000 },
  { serial:'PI-2303', pos:'2-TIE', vehicle:'INT-23', brand:'Pirelli TH01',       size:'315/70R22.5', km:31200,  depth:9,  maxDepth:14, status:'ok',     purchase:180000 },
  { serial:'PI-2304', pos:'2-TII', vehicle:'INT-23', brand:'Pirelli TH01',       size:'315/70R22.5', km:31200,  depth:8,  maxDepth:14, status:'ok',     purchase:180000 },
  { serial:'PI-2305', pos:'2-TDE', vehicle:'INT-23', brand:'Pirelli TH01',       size:'315/70R22.5', km:31200,  depth:3,  maxDepth:14, status:'danger', purchase:180000 },
  { serial:'PI-2306', pos:'2-TDD', vehicle:'INT-23', brand:'Pirelli TH01',       size:'315/70R22.5', km:31200,  depth:10, maxDepth:14, status:'ok',     purchase:180000 },

  // ── INT-05 — Tractor 6×4 con alertas (10 cubiertas)
  { serial:'SC-0501', pos:'1-DI',  vehicle:'INT-05', brand:'Scania OEM R+',      size:'295/80R22.5', km:98400,  depth:8,  maxDepth:16, status:'warn',   purchase:172000 },
  { serial:'SC-0502', pos:'1-DD',  vehicle:'INT-05', brand:'Scania OEM R+',      size:'295/80R22.5', km:98400,  depth:7,  maxDepth:16, status:'warn',   purchase:172000 },
  { serial:'RC-0503', pos:'2-TIE', vehicle:'INT-05', brand:'Recapado Sur 295',   size:'295/80R22.5', km:62000,  depth:5,  maxDepth:10, status:'warn',   purchase:85000  },
  { serial:'RC-0504', pos:'2-TII', vehicle:'INT-05', brand:'Recapado Sur 295',   size:'295/80R22.5', km:62000,  depth:4,  maxDepth:10, status:'danger', purchase:85000  },
  { serial:'RC-0505', pos:'2-TDE', vehicle:'INT-05', brand:'Recapado Sur 295',   size:'295/80R22.5', km:62000,  depth:6,  maxDepth:10, status:'warn',   purchase:85000  },
  { serial:'RC-0506', pos:'2-TDD', vehicle:'INT-05', brand:'Recapado Sur 295',   size:'295/80R22.5', km:62000,  depth:5,  maxDepth:10, status:'warn',   purchase:85000  },
  { serial:'BT-0507', pos:'3-TIE', vehicle:'INT-05', brand:'Bridgestone M788',   size:'295/80R22.5', km:41200,  depth:11, maxDepth:14, status:'ok',     purchase:178000 },
  { serial:'BT-0508', pos:'3-TII', vehicle:'INT-05', brand:'Bridgestone M788',   size:'295/80R22.5', km:41200,  depth:10, maxDepth:14, status:'ok',     purchase:178000 },
  { serial:'BT-0509', pos:'3-TDE', vehicle:'INT-05', brand:'Bridgestone M788',   size:'295/80R22.5', km:41200,  depth:11, maxDepth:14, status:'ok',     purchase:178000 },
  { serial:'BT-0510', pos:'3-TDD', vehicle:'INT-05', brand:'Bridgestone M788',   size:'295/80R22.5', km:41200,  depth:9,  maxDepth:14, status:'ok',     purchase:178000 },

  // ── STOCK — cubiertas disponibles para montar
  { serial:'ST-N001', pos:'Stock', vehicle:'STOCK', brand:'Bridgestone R168',    size:'295/80R22.5', km:0,      depth:16, maxDepth:16, status:'ok',     purchase:180000 },
  { serial:'ST-N002', pos:'Stock', vehicle:'STOCK', brand:'Bridgestone R168',    size:'295/80R22.5', km:0,      depth:16, maxDepth:16, status:'ok',     purchase:180000 },
  { serial:'ST-N003', pos:'Stock', vehicle:'STOCK', brand:'Michelin XDE2+',      size:'295/80R22.5', km:0,      depth:14, maxDepth:14, status:'ok',     purchase:195000 },
  { serial:'ST-N004', pos:'Stock', vehicle:'STOCK', brand:'Goodyear KMAX D',     size:'295/80R22.5', km:0,      depth:14, maxDepth:14, status:'ok',     purchase:190000 },
  { serial:'ST-R001', pos:'Stock', vehicle:'STOCK', brand:'Recapado Neumáticos Sur', size:'295/80R22.5', km:48000, depth:10, maxDepth:10, status:'ok',  purchase:88000  },
  { serial:'ST-R002', pos:'Stock', vehicle:'STOCK', brand:'Recapado Neumáticos Sur', size:'295/80R22.5', km:52000, depth:9,  maxDepth:10, status:'ok',  purchase:88000  },
];

App.data.stock = [
  { id:1, code:'FLT-ACE-001', name:'Filtro aceite motor MB Actros',   cat:'Filtros',    unit:'un', qty:8,  min:4,  reorder:6,  cost:4200,  supplier:'AutoRep SA' },
  { id:2, code:'FLT-ACE-002', name:'Filtro aceite motor Scania R',    cat:'Filtros',    unit:'un', qty:6,  min:4,  reorder:5,  cost:3900,  supplier:'AutoRep SA' },
  { id:3, code:'FLT-CMB-001', name:'Filtro combustible primario MB',  cat:'Filtros',    unit:'un', qty:10, min:5,  reorder:7,  cost:2800,  supplier:'AutoRep SA' },
  { id:4, code:'FLT-AIR-001', name:'Filtro aire MB Actros',           cat:'Filtros',    unit:'un', qty:4,  min:4,  reorder:5,  cost:6500,  supplier:'Filtrox' },
  { id:5, code:'ACE-MOT-001', name:'Aceite motor 15W-40 bulk',        cat:'Lubricantes',unit:'L',  qty:380,min:200,reorder:250,cost:820,   supplier:'Lubricor' },
  { id:6, code:'ACE-CAJ-001', name:'Aceite caja Meritor manual',      cat:'Lubricantes',unit:'L',  qty:45, min:20, reorder:30, cost:1450,  supplier:'Lubricor' },
  { id:7, code:'ACE-DIF-001', name:'Aceite diferencial 85W-140',      cat:'Lubricantes',unit:'L',  qty:32, min:20, reorder:25, cost:1320,  supplier:'Lubricor' },
  { id:8, code:'GRS-001',     name:'Grasa EP2 multiuso 20kg balde',   cat:'Lubricantes',unit:'kg', qty:3,  min:2,  reorder:3,  cost:18500, supplier:'Lubricor' },
  { id:9, code:'BAT-001',     name:'Batería 12V 150Ah Bosch',         cat:'Eléctrico',  unit:'un', qty:2,  min:2,  reorder:2,  cost:48000, supplier:'Electro Sur' },
  { id:10,code:'RUL-001',     name:'Rulemán masa delantera MB',        cat:'Mecánico',   unit:'un', qty:4,  min:2,  reorder:3,  cost:22000, supplier:'Rodamientos SA' },
  { id:11,code:'COR-001',     name:'Correa dentada distribución',     cat:'Mecánico',   unit:'un', qty:2,  min:1,  reorder:2,  cost:35000, supplier:'Mec-Parts' },
  { id:12,code:'FRN-001',     name:'Zapatas freno eje trasero MB',    cat:'Frenos',     unit:'jgo',qty:3,  min:2,  reorder:3,  cost:28000, supplier:'Mec-Parts' },
  { id:13,code:'REF-001',     name:'Líquido refrigerante orgánico 20L',cat:'Lubricantes',unit:'L', qty:60, min:40, reorder:50, cost:380,   supplier:'Lubricor' },
  { id:14,code:'FLT-SEP-001', name:'Separador agua combustible MB',   cat:'Filtros',    unit:'un', qty:8,  min:4,  reorder:6,  cost:3200,  supplier:'AutoRep SA' },
  { id:15,code:'TOR-001',     name:'Pernos rueda M22×1.5 (x10)',      cat:'Tornillería',unit:'jgo',qty:6,  min:3,  reorder:4,  cost:4800,  supplier:'Ferretería Central' },
];

App.data.documents = [
  { id:1, vehicle:'INT-05', plate:'ABC 105', type:'VTV',     expiry:'2026-04-21', status:'warn',   file:'vtv_int05.pdf' },
  { id:2, vehicle:'INT-17', plate:'MNO 501', type:'VTV',     expiry:'2026-04-15', status:'warn',   file:'vtv_int17.pdf' },
  { id:3, vehicle:'INT-31', plate:'EFG 022', type:'Seguro',  expiry:'2026-04-30', status:'warn',   file:'seg_int31.pdf' },
  { id:4, vehicle:'INT-08', plate:'DEF 203', type:'VTV',     expiry:'2026-05-10', status:'ok',     file:'vtv_int08.pdf' },
  { id:5, vehicle:'INT-22', plate:'STU 702', type:'Seguro',  expiry:'2026-04-12', status:'danger', file:'seg_int22.pdf' },
  { id:6, vehicle:'INT-15', plate:'JKL 402', type:'Habilitación',expiry:'2026-04-18',status:'warn',file:'hab_int15.pdf' },
  { id:7, vehicle:'INT-29', plate:'BCD 012', type:'VTV',     expiry:'2026-06-15', status:'ok',     file:'vtv_int29.pdf' },
  { id:8, vehicle:'INT-35', plate:'HIJ 033', type:'Seguro',  expiry:'2026-05-20', status:'ok',     file:'seg_int35.pdf' },
...
function getAxleConfig(vehicle) {
  // Si el vehículo tiene config personalizada en tech_spec.axles, usarla
  ...
  if (customAxles && customAxles.length > 0) {
    return customAxles.map((axle, i) => {
      ...
      if (axle.dual) {
        return {
          name: `Eje ${n} — ${axle.label||'Portante'}`,
          positions: [`${prefix}${n}-IE`,`${prefix}${n}-II`,`${prefix}${n}-DE`,`${prefix}${n}-DD`],
          dual: true
        };
      } else {
        return {
          name: `Eje ${n} — ${axle.label||'Dirección'}`,
          positions: [`${prefix}${n}-DI`,`${prefix}${n}-DD`],
          dual: false
        };
      }
    });
  }
  // Fallback a config por tipo
  const DEFAULTS = {
    tractor: [
