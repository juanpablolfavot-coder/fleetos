...
async function migrate() {
  ...
  try {
    ...
    const sqlFiles = ['schema.sql', '01-compras.sql', '02-pagos.sql', '03-status-auto.sql', '04-workflow.sql', '05-workflow-cerrada.sql', '06-stock-catalog.sql', '07-fks-indexes.sql'];
